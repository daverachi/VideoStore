...
{
    public class FilmContributorTypeRepository : BaseRepository<FilmContributorType>, IFilmContributorTypeRepository
    {
        private IUnitOfWork _UnitOfWork;
        private INlogger _log;

        public FilmContributorTypeRepository(IUnitOfWork UnitOfWork, INlogger log)
            : base(UnitOfWork, log)
        {
