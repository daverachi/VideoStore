...
{
    public class InventoryItemFormatTypeRepository : BaseRepository<InventoryItemFormatType>, IInventoryItemFormatTypeRepository
    {
        private IUnitOfWork _UnitOfWork;
        private INlogger _log;

        public InventoryItemFormatTypeRepository(IUnitOfWork UnitOfWork, INlogger log)
            : base(UnitOfWork, log)
        {
