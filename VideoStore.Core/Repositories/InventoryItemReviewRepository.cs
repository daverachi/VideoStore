...
{
    public class InventoryItemReviewRepository : BaseRepository<InventoryItemReview>, IInventoryItemReviewRepository
    {
        private IUnitOfWork _UnitOfWork;
        private INlogger _log;

        public InventoryItemReviewRepository(IUnitOfWork UnitOfWork, INlogger log)
            : base(UnitOfWork, log)
        {
