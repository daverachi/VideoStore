...
{
    public class InventoryItemItemTypeRepository : BaseRepository<InventoryItemItemType>, IInventoryItemItemTypeRepository
    {
        private IUnitOfWork _UnitOfWork;
        private INlogger _log;

        public InventoryItemItemTypeRepository(IUnitOfWork UnitOfWork, INlogger log)
            : base(UnitOfWork, log)
        {
