...
{
    public class InventoryItemPurchaseTypeRepository : BaseRepository<InventoryItemPurchaseType>, IInventoryItemPurchaseTypeRepository
    {
        private IUnitOfWork _UnitOfWork;
        private INlogger _log;

        public InventoryItemPurchaseTypeRepository(IUnitOfWork UnitOfWork, INlogger log)
            : base(UnitOfWork, log)
        {
